    ...
    <>
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-side">
          ...
          <aside className="min-h-full w-80 bg-base-100 border-r border-base-200">
            {/* Sidebar Header */}
            <div className="p-4 border-b border-base-200">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold">Menu</h2>
                <button className="btn btn-ghost btn-circle btn-sm lg:hidden" onClick={() => setIsSidebarOpen(false)}>
            ...
            <div className="p-4">
              <ul className="menu menu-lg w-full">
                <li>
                  <button
                    className={`flex items-center gap-3 rounded-lg ${activeTab === "chat" ? "active" : ""}`}
                ...
                <li>
                  <button
                    className={`flex items-center gap-3 rounded-lg ${activeTab === "history" ? "active" : ""}`}
                ...
                <li>
                  <button
                    className={`flex items-center gap-3 rounded-lg ${activeTab === "profile" ? "active" : ""}`}
                ...
                <li>
                  <button
                    className={`flex items-center gap-3 rounded-lg ${activeTab === "settings" ? "active" : ""}`}
              ...
              <div className="p-4">
                <div className="card bg-base-200 rounded-lg">
                  <div className="card-body p-4">
                    <h3 className="card-title text-sm flex items-center gap-2 font-semibold">
                    ...
                    <ul className="text-xs space-y-1 opacity-80">
                      {loadedModules.map((module, index) => (
                        <li key={index} className="flex items-center gap-2">
                          <span className="material-icons text-[0.7rem]">{module.icon || "extension"}</span>
                ...
                <div className="card-body p-4">
                  ...
                  <ul className="text-xs space-y-1 opacity-80">
                    <li className="flex items-center gap-2">
                      <span className="material-icons text-[0.7rem]">code</span>
                      <span className="font-medium">Code explanations</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="material-icons text-[0.7rem]">bug_report</span>
                      <span className="font-medium">Debug assistance</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="material-icons text-[0.7rem]">work</span>
                      <span className="font-medium">Career advice</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="material-icons text-[0.7rem]">quiz</span>
            ...
            <div className="p-4">
              <div className="card bg-base-200 rounded-lg">
                <div className="card-body p-4">
                  <h3 className="card-title text-sm flex items-center gap-2 font-semibold">
                    <span className="material-icons text-base">flash_on</span>
                    Quick Actions
                  </h3>
                  <div className="flex flex-col gap-2 mt-2">
                    <button className="btn btn-outline btn-sm justify-start rounded-lg">
